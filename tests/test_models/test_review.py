...
class TestReview(unittest.TestCase):
    ...
    def test_content_attr(self):
        """Test that Review has attr content, and it's an empty string"""
        review = Review()
        self.assertTrue(hasattr(review, "content"))
        self.assertEqual(review.content, "")

    def test_event_id_attr(self):
        """Test that Review has attr event_id, and it's an empty string"""
        review = Review()
        self.assertTrue(hasattr(review, "event_id"))
        self.assertEqual(review.event_id, "")
    ...
    def test_event_attr(self):
        """Test that Review has attr event, and it's None"""
        review = Review()
        self.assertTrue(hasattr(review, "event"))
        self.assertIsNone(review.event)

    def test_user_attr(self):
        """Test that Review has attr user, and it's None"""
        review = Review()
