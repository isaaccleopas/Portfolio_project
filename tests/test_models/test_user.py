...
class TestUser(unittest.TestCase):
    ...
    def test_name_attr(self):
        """Test that User has attr name, and it's an empty string"""
        user = User()
    ...
    def test_events_attr(self):
        """Test that User has attr events, and it's an empty list"""
        user = User()
        self.assertTrue(hasattr(user, "events"))
        self.assertEqual(user.events, [])

    def test_reservations_attr(self):
        """Test that User has attr reservations, and it's an empty list"""
        user = User()
        self.assertTrue(hasattr(user, "reservations"))
